...
public interface ActividadRepository extends JpaRepository<Actividad,String> {
    ...
    //modificar
    @Modifying
    @Query("UPDATE FROM Actividad a SET a.nombre = :nombre")
    public void modificarNombre(@Param("nombre") String nombre);
    
    @Modifying
    @Query("UPDATE FROM Actividad a SET a.precio = :precio")
    public void modificarPrecio(@Param("precio") Double precio);
    
    @Modifying
    @Query("UPDATE FROM Actividad a SET a.lugar = :lugar")
    public void modificarLugar(@Param("lugar") String lugar);
    
    @Modifying
    @Query("UPDATE FROM Actividad a SET a.nombre = :nombre, a.lugar = :lugar, a.precio = :precio")
    public void modificarTodo(@Param("nombre") String nombre, @Param("lugar") String lugar, @Param("precio") Double precio);
